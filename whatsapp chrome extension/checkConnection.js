...
setTimeout(() => {
    ...
    if (!body.contains(qrCode)) {
        document.getElementsByClassName('_3GlyB dwbWf')[0].click();
        const phoneNumber = document.getElementsByClassName('erpdyial i0jNr selectable-text copyable-text')[0].innerHTML;
